window.addEventListener("load", () => {
  ...
  function init() {
    totalSeconds = Math.floor((new Date("10/04/2024") - new Date()) / 1000);
    setTimeLeft();
...
function showDiv(buttonType) {
    const coreTeam = document.querySelector('.Core_Team');
    const coreTeamO = document.querySelector('.Core_Team_O');
    const coreTeamT = document.querySelector('.Core_Team_T');
  
    coreTeam.style.visibility = 'hidden';
    coreTeamO.style.visibility = 'hidden';
    coreTeamT.style.visibility = 'hidden';
  
    if (buttonType === 'Coordinator') {
      coreTeam.style.visibility = 'visible';
    } else if (buttonType === 'CoCoordinator') {
      coreTeamO.style.visibility = 'visible';
    } else if (buttonType === 'Members') {
      coreTeamT.style.visibility = 'visible';
    }
  }
  
  document.querySelector('.Coordinator_Button').addEventListener('click', function() {
    showDiv('Coordinator');
  });
  
  document.querySelector('.CoCoordinator_Button').addEventListener('click', function() {
    showDiv('Members');
  });
  
  document.querySelector('.Members_Button').addEventListener('click', function() {
    showDiv('CoCoordinator');
  });
